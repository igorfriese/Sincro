        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenAcompanhamento = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coluna = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistradoPorId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventoPedidos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventoPedidos_Pedidos_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_TokenAcompanhamento",
                table: "Clientes",
                column: "TokenAcompanhamento",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Etapas_Chave",
                table: "Etapas",
                column: "Chave",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventoPedidos_PedidoId",
                table: "EventoPedidos",
                column: "PedidoId");
